...
export class CorporateUserComponent implements OnInit {
  enableCorporateTable: boolean;
  enableBranchTable: boolean;
  searchBy: string;
  ...
  search(value){
    ...
    if(this.reportName  && this.fromDate && this.toDate && this.searchBy){
  ...
  Onchange(value){
    console.log(value)
if(value == 'corporate'){
  this.enableCorporateTable=true;
  this.enableBranchTable=false;
  this.enableTable1=false;
  this.enableTable2=false;
} 
else{
  this.enableBranchTable=true;
  this.enableTable1=true;
  this.enableTable2=false;
  this.enableCorporateTable=false;
}
